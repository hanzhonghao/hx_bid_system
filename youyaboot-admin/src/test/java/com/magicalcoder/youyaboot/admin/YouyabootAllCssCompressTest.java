...
/**
    自动压缩合并youyaboot-all.css;
    为了获取更高的性能。当发布上线时，youyaboot加载单独的1个css 避免加载多个js导致加载速度慢的问题
 */
public class YouyabootAllCssCompressTest {
    public static void main(String[] args) {
        ...
        String cssPath = String.format("%s\\src\\main\\resources\\static\\assets\\magicalcoder\\v103\\css\\",youyabootAdminPath).replace("\\",File.separator);
        ...
        String youyabootAllMinJs = cssPath+"youya-boot-all.min.css";
