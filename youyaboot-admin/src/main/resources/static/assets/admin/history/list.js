...
// 子表 排序相关
    var CONFIG = {
        tableNameRest:"history_rest",
        tableName:"history",
        moduleName:"history",//sys_module的moduleName
        form:{
                bidTime:{
        ...
        //排序跟数据库实际字段名的映射
        sortMap:{
            id:'id',bidProject:'bid_project',bidTime:'bid_time',projectName:'project_name',purchaserName:'purchaser_name'
        }
    };
    //后端请求时候的表模块规则url
    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
            ...
            {field: 'purchaserName', title: '采购员姓名', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.purchaserName) +'" class="magicalcoder-table-text layui-input security_list_table_form_purchaserName" name="purchaserName" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="采购员姓名"/>'
                }
                , sort:true
            },
