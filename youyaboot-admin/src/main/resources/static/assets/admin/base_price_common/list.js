...
// 子表 排序相关
    var CONFIG = {
        ...
        tableName:"base_price_common",
        moduleName:"base_price_common",//sys_module的moduleName
        form:{
                inputTime:{
    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
            ...
            {field: 'finalPoint', title: '最终价格(万元）', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.finalPoint) +'" class="magicalcoder-table-text layui-input security_list_table_form_finalPoint" name="finalPoint" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="最终价格(万元）"/>'
                }
                , sort:true
            },
