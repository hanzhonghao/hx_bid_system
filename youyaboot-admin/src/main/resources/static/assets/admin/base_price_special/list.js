...
// 子表 排序相关
    var CONFIG = {
        ...
        tableName:"base_price_special",
        moduleName:"base_price_special",//sys_module的moduleName
        form:{
                inputTime:{
    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
                ...
                {field: 'projectId', title: '参选公司', align:'center', minWidth:250, templet:function (d) {
                    ...
                    return '<select class="magicalcoder-table-foreign-select2 layui-input security_list_table_form_projectId" lay-ignore="true"  name="projectId" data-identify="'+d.id+'" data-value="'+value+'" data-url="admin/project_rest/search" data-id="id" data-text-fields="projectName" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="参选公司"  data-limit="20"></select>'
                    },sort:true
                },
