        ...
        layTable:function () {//表格
            var tableObj = {
                ...
                initCOLS: function () {
                    ...
                    //             var temp = {field: 'scoreSum' + i, title: list2[i], minWidth: 200}
                    //             COLS[0].push(temp);
                    //         }
                    //
                    //     }
                    ...
                    COLS[0].push({
                        field: 'eBasePoint', title: '设备基准价', minWidth: 200, templet: function (d) {
                            return '<input type="text" value="' + mc_util.escapeHTML(d.ebasePoint) + '" class="magicalcoder-table-text layui-input security_list_table_form_basePoint" name="basePoint" data-identify="' + d.id + '" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="基准价"/>'
                        }
                        , sort: true
                    });
                    COLS[0].push({
                        field: 'eFinalPoint', title: '设备最终价', minWidth: 200, templet: function (d) {
                            return '<input type="text" value="' + mc_util.escapeHTML(d.efinalPoint) + '" class="magicalcoder-table-text layui-input security_list_table_form_finalPoint" name="finalPoint" data-identify="' + d.id + '" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="最终价"/>'
                        }
                        , sort: true
                    });
                    COLS[0].push({
                        field: 'sBasePoint', title: '试剂基准价', minWidth: 200, templet: function (d) {
                            return '<input type="text" value="' + mc_util.escapeHTML(d.sbasePoint) + '" class="magicalcoder-table-text layui-input security_list_table_form_basePoint" name="basePoint" data-identify="' + d.id + '" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="基准价"/>'
                        }
                        , sort: true
                    });
                    COLS[0].push({
                        field: 'sBinalPoint', title: '试剂最终价', minWidth: 200, templet: function (d) {
                            return '<input type="text" value="' + mc_util.escapeHTML(d.sfinalPoint) + '" class="magicalcoder-table-text layui-input security_list_table_form_finalPoint" name="finalPoint" data-identify="' + d.id + '" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="最终价"/>'
                        }
                        , sort: true
                    });
                    COLS[0].push({
