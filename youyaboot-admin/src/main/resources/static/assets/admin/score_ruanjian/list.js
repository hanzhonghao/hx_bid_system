...
// 子表 排序相关
    var CONFIG = {
        tableNameRest:"score_ruanjian_rest",
        tableName:"score_ruanjian",
        moduleName:"score_ruanjian",//sys_module的moduleName
        form:{
        },
        event:{
    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
            ...
            {field: 'afterSale', title: 'after_sale', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.afterSale) +'" class="magicalcoder-table-text layui-input security_list_table_form_afterSale" name="afterSale" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="after_sale"/>'
                }
                , sort:true
            },

            {field: 'apply', title: 'apply', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.apply) +'" class="magicalcoder-table-text layui-input security_list_table_form_apply" name="apply" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="apply"/>'
                }
                , sort:true
            },

            {field: 'companyName', title: 'company_name', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.companyName) +'" class="magicalcoder-table-text layui-input security_list_table_form_companyName" name="companyName" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="company_name"/>'
                }
                , sort:true
            },

            {field: 'geneSitu', title: 'gene_situ', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.geneSitu) +'" class="magicalcoder-table-text layui-input security_list_table_form_geneSitu" name="geneSitu" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="gene_situ"/>'
                }
                , sort:true
            },

            {field: 'standard', title: 'standard', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.standard) +'" class="magicalcoder-table-text layui-input security_list_table_form_standard" name="standard" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="standard"/>'
                }
                , sort:true
            },

            {field: 'techRequire', title: 'tech_require', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.techRequire) +'" class="magicalcoder-table-text layui-input security_list_table_form_techRequire" name="techRequire" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="tech_require"/>'
                }
                , sort:true
            },

            {field: 'signature', title: 'signature', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.signature) +'" class="magicalcoder-table-text layui-input security_list_table_form_signature" name="signature" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="signature"/>'
                }
                , sort:true
            },
