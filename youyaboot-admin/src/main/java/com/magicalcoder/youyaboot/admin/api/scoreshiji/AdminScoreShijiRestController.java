package com.magicalcoder.youyaboot.admin.api.scoreshiji;
...
import com.magicalcoder.youyaboot.model.ScoreShiji;
import com.magicalcoder.youyaboot.service.scoreshiji.service.ScoreShijiService;
...
@RequestMapping("/admin/score_shiji_rest/")
@RestController
public class AdminScoreShijiRestController extends CommonRestController<ScoreShiji,Long> implements InitializingBean
{

    @Resource
    private ScoreShijiService scoreShijiService;
    ...
    public ResponseMsg page(
        ...
        Integer count = scoreShijiService.getModelListCount(query);
        ...
        if(queryType==null || queryType == QUERY_TYPE_SEARCH){//普通查询
            ...
            return new ResponseMsg(count,scoreShijiService.getModelList(query));
        }else if(queryType == QUERY_TYPE_EXPORT_EXCEL){
            query.put("start",(page - 1) * limit);query.put("limit",limit);
            exportExcel(response,scoreShijiService.getModelList(query),"score_shiji",
    ...
    public void afterPropertiesSet() throws Exception {
        super.commonService = scoreShijiService;
